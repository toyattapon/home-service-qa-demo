...
export function InvoiceDetailPage() {
  ...
  async function pay() {
    ...
    setBusy(true);
    try {
      setInvoice(await invoiceApi.pay(id));
      setConfirm(false);
      setError('');
    } catch (caught) {
